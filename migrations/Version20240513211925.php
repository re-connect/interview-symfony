 ...
 */
final class Version20240513211925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE beneficiary ADD COLUMN creator VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE beneficiary ADD COLUMN created_at DATETIME NOT NULL');
    }
